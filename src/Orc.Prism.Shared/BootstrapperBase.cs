// --------------------------------------------------------------------------------------------------------------------
// <copyright file="BootstrapperBase.cs" company="WildGums">
...
namespace Orc.Prism
{
    ...
    public abstract class BootstrapperBase : Bootstrapper
    {
...
#if PRISM6
                Container.RegisterTypeIfNotYetRegistered<IModuleInitializer, global::Prism.Modularity.ModuleInitializer>();
#else
        ...
        private bool RegisterModule(ModuleInfo moduleInfo)
        {
            ...
            // Use allowInitialization: false in Catel v5
