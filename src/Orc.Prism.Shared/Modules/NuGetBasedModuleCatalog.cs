// --------------------------------------------------------------------------------------------------------------------
// <copyright file="NuGetBasedModuleCatalog.cs" company="WildGums">
        ...
        */
        ...
        public string OutputDirectoryFullPath
        {
            get
            {
                ...
                {
                    var mainModuleDirectory = Catel.IO.Path.GetDirectoryName(Process.GetCurrentProcess().MainModule.FileName);
                    outputDirectory = Catel.IO.Path.Combine(mainModuleDirectory, OutputDirectory);
                }
